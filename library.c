...
char catagories[][ 15 ]={ "Computer" , "Electronics" , "Mechatronics" , "Civil" , "Mechanical" , "Architecture", "References" };
...
system ( "cls" );
gotoxy ( 20 , 3 );
 printf("\tDEDAN KIMATHI LIBRARY SECTION\t\t\t");
...
printf ( "Programmers...." );
gotoxy ( 16 , 4 );
printf ( "1. Patrick Waweru" );
gotoxy ( 16 , 5 );
printf ( "Mobile:+254727751832\t\tE-mail:858wpwaweru@gmail.com\n\n" );
printf ( "\t\tContact for Help with library management application\n" );
gotoxy ( 10 , 17);
...
system ( "cls" );
gotoxy ( 20 , 5 );
printf ( "\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2SELECT CATEGOIES\xB2\xB2\xB2\xB2\xB2\xB2\xB2\n");
gotoxy ( 20 , 7 );
...
gotoxy ( 20 , 12 );
printf ( "\xB2 Quantity: %d " ,a.quantity); gotoxy ( 47 , 12 ); printf ( "\xB2" ); gotoxy ( 47 , 11 );
gotoxy ( 20 , 13 );
...
printf ( "The book record is available" );
gotoxy ( 10 , 9 );
printf ( "There are %d un-issued books in library " ,a.quantity);
gotoxy ( 10 , 10 );
...
gotoxy ( 20 , 4 ); printf ( "\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\n");
gotoxy ( 20 , 5 );
